                ...
                <div class="card">
                    ...
                    <form action="{{ route('usuarios.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="mb-3 mt-4"><i class="fas fa-lock"></i> Seguridad</h5>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('tipo_sangre_id') is-invalid @enderror"
                                            ...
                                            @foreach ($tiposSangre as $tipo)
                                                <option value="{{ $tipo->id }}"
                                                    {{ old('tipo_sangre_id') == $tipo->id ? 'selected' : '' }}>
                                                    {{ $tipo->codigo }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select class="form-control @error('nivel_entrenamiento_id') is-invalid @enderror"
                                            ...
                                            @foreach ($nivelesEntrenamiento as $nivel)
                                                <option value="{{ $nivel->id }}"
                                                    {{ old('nivel_entrenamiento_id') == $nivel->id ? 'selected' : '' }}>
                                                    {{ $nivel->nivel }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('entidad_perteneciente') }}">
