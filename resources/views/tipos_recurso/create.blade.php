        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form action="{{ route('tipos_recurso.store') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @error('categoria')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                        <small class="form-text text-muted">Categoría a la que pertenece el recurso</small>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @error('unidad_medida')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                        <small class="form-text text-muted">Unidad en la que se mide el recurso</small>
                                    </div>
                                </div>
                            </div>
