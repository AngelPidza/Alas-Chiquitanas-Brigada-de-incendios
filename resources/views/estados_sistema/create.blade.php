                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 @error('tabla') is-invalid @enderror"
                                            ...
                                            <option value="usuarios" {{ old('tabla') == 'usuarios' ? 'selected' : '' }}>usuarios</option>
                                            <option value="equipos" {{ old('tabla') == 'equipos' ? 'selected' : '' }}>equipos</option>
                                            <option value="reportes" {{ old('tabla') == 'reportes' ? 'selected' : '' }}>reportes</option>
                                            <option value="recursos" {{ old('tabla') == 'recursos' ? 'selected' : '' }}>recursos</option>
                                        </select>
                                        @error('tabla')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               ...
                                               id="codigo"
                                               name="codigo"
                                               placeholder="Ej: pendiente, activo, finalizado"
                                               value="{{ old('codigo') }}"
                                               required
                                               maxlength="50">
                                        @error('codigo')
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('descripcion') is-invalid @enderror"
                                          ...
                                          name="descripcion"
                                          rows="2"
                                          placeholder="Describe las características de este estado...">{{ old('descripcion') }}</textarea>
                                @error('descripcion')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
