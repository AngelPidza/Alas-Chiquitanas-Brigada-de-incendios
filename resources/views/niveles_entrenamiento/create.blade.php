                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        @enderror
                                        <small class="form-text text-muted">Nombre del nivel de entrenamiento (máx. 50 caracteres)</small>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('descripcion') is-invalid @enderror"
                                          ...
                                          name="descripcion"
                                          rows="3"
                                          placeholder="Describe las características y requisitos de este nivel...">{{ old('descripcion') }}</textarea>
                                @error('descripcion')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
