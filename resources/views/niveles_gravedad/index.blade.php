...
@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Niveles de Gravedad</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">Inicio</a></li>
                    <li class="breadcrumb-item"><a href="#">Catálogos</a></li>
                    <li class="breadcrumb-item active">Niveles de Gravedad</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Listado de Niveles de Gravedad</h3>
                <div class="card-tools">
                    <a href="{{ route('niveles-gravedad.create') }}" class="btn btn-primary btn-sm">
                        <i class="fas fa-plus"></i> Nuevo Nivel
                    </a>
                </div>
            </div>
            <div class="card-body">
                <table id="niveles-gravedad-table" class="table table-bordered table-striped table-hover">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach($niveles as $nivel)
                            <tr>
                                ...
                                <td><strong>{{ $nivel->codigo }}</strong></td>
                                <td>{{ $nivel->nombre }}</td>
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            $('#niveles-gravedad-table').DataTable({
                responsive: true,
                language: {
